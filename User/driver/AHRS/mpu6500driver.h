...
#define GYRO_OFFSET_KP 0.0002f //调整这个可以调整陀螺仪校准速度，越大陀螺仪校准变化越快，但波动会变大
...
//陀螺仪开机校准的时间
#define GYRO_OFFSET_START_TIME 5000
...
//陀螺仪校准
extern void gyro_offset(fp32 gyro_offset[3], fp32 gyro[3], uint8_t imu_status, int16_t *offset_time_count);
