...
#define OLED_SCL_Clr() GPIO_ResetBits(GPIOF,GPIO_Pin_0)//SCL
#define OLED_SCL_Set() GPIO_SetBits(GPIOF,GPIO_Pin_0)

#define OLED_SDA_Clr() GPIO_ResetBits(GPIOE,GPIO_Pin_4)//SDA
#define OLED_SDA_Set() GPIO_SetBits(GPIOE,GPIO_Pin_4)
